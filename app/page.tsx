  ...
  const courses = [
    {
      ...
      gradeData: [
        { grade: "A", count: 145, percentage: 58.5 },
        { grade: "B", count: 68, percentage: 27.4 },
        { grade: "C", count: 23, percentage: 9.3 },
        { grade: "DNF", count: 12, percentage: 4.8 },
      ],
    },
    {
      code: "CS 313",
      ...
      gradeData: [
        { grade: "A", count: 98, percentage: 37.3 },
        { grade: "B", count: 102, percentage: 38.8 },
        { grade: "C", count: 45, percentage: 17.1 },
        { grade: "DNF", count: 18, percentage: 6.8 },
      ],
    },
    {
      code: "CS 415",
